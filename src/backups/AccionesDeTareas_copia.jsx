...
export const AccionesTareas = ({ item, onDelete, onUpdate }) => {
  ...
  function TareasElement() {
    return (
      <tbody className="border-b p-2 mb-8 rounded-lg border-gray-100">
        <tr>
          ...
          <td className=" border-b border-gray-100 bg-white px-5 py-5 text-sm">
            <span className="relative">{selected.name}</span>
          </td>
          <td className="border-b border-gray-100 px-5 py-5 text-sm">
            <a href="#" className="text-indigo-600 hover:text-indigo-900">
              <button
          ...
          <td className="border-b border-gray-200  px-5 py-5 text-center text-sm">
            <a href="#" className="text-red-600 hover:text-indigo-900">
              <button onClick={() => setPulsado(!pulsado)}>
                {pulsado ? <ModalComponent 
                      key={item.id}
